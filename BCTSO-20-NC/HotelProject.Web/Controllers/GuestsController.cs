...
namespace HotelProject.Web.Controllers
{
    public class GuestsController : Controller
    {
        ...
        {
            List<GuestReservation> rawData = await _guestReservationRepository.GetAllAsync(includeProperties: "Guest,Reservation");
        ...
        {
            var result = await _guestReservationRepository.GetAsync(x => x.Id == id, includeProperties: "Guest,Reservation");
            return View(result);
        }
        ...
        {
            var rawData = await _guestReservationRepository.GetAsync(x => x.Id == id, includeProperties: "Guest,Reservation");
